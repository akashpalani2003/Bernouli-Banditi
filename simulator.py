...
def task2(algorithm, probs, num_sims=50):
  ...
  print(net_rewards)
  plt.plot(horizons, net_rewards)
  plt.title("Rewards vs Horizon")
  plt.savefig("task2-{}-{}.png".format(algorithm.__name__, time.strftime("%Y%m%d-%H%M%S")))
  plt.clf()
...
if __name__ == '__main__':
  ...
  print(f"Probs: {task1probs}, Number of arms: {len(task1probs)}")

  #task1(Eps_Greedy, task1probs, 2)
  #task1(UCB, task1probs,50)
